...
if(isset($_POST['submit'])){   // Retrieve form data
    ...
    $stmt = $conn->prepare("INSERT INTO `renewpass`(`username`, `email`, `from_date`, `to_date`, `old_pass`, `verification_code`) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $username, $email, $from_date, $to_date, $old_pass, $verification_code);
        ...
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <button class="btn btn-info" onclick="document.getElementById('id01').style.display='block'"
              style="width:auto;">Apply Pass</button>
          </div>
        </div>
      </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group focused">
                                ...
                                <input type="text" id="input-username" class="form-control form-control-alternative" name="input-username" placeholder="Username" >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group focused">
                                ...
                                <input type="date" id="output-date" class="form-control form-control-alternative" name="output-date" >
                            </div>
                        </div>
                    </div>
                </div>
